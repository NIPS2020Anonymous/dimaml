...
class ImageNetFixupBasicBlock(nn.Module):
    expansion = 1

    def __init__(self, inplanes, planes, stride=1, downsample=None):
        super(ImageNetFixupBasicBlock, self).__init__()
...
class ImageNetFixupResNet(nn.Module):
    def __init__(self, block, layers, num_classes=10):
        super(ImageNetFixupResNet, self).__init__()
        ...
        for name, m in self.named_modules():
            if isinstance(m, ImageNetFixupBasicBlock):
...
def ImageNetFixupResNet18(**kwargs):
    """Constructs a Fixup-ResNet-18 model.
    """
    model = ImageNetFixupResNet(ImageNetFixupBasicBlock, [2, 2, 2, 2], **kwargs)
    return model


def ImageNetFixupResNet34(**kwargs):
    """Constructs a Fixup-ResNet-34 model.
    """
    model = ImageNetFixupResNet(ImageNetFixupBasicBlock, [3, 4, 6, 3], **kwargs)
    return model
